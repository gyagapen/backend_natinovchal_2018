...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2019 at 07:58 PM
...
(93, 'Cedric Azémia', '', 29, 'A', 'Astma, cardiac', 'MMB29M-Lenovo Z90a40', '', 'PENDING', 'Health', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);

-- --------------------------------------------------------

--
-- Table structure for table `help_request_location`
--
...
--
-- Dumping data for table `help_request_location`
--
...
--
-- Table structure for table `help_request_provider_need`
--
...
--
-- Dumping data for table `help_request_provider_need`
--
...
--
-- Table structure for table `service_provider_patrol`
--
...
--
-- Dumping data for table `service_provider_patrol`
--
...
--
-- Table structure for table `service_provider_patrol_assignment`
--
...
--
-- Dumping data for table `service_provider_patrol_assignment`
--
...
--
-- Table structure for table `service_provider_patrol_location`
--
...
--
-- Indexes for table `help_request_location`
--
ALTER TABLE `help_request_location`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `help_request_provider_need`
--
...
--
-- Indexes for table `service_provider_patrol`
--
...
--
-- Indexes for table `service_provider_patrol_assignment`
--
ALTER TABLE `service_provider_patrol_assignment`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `service_provider_patrol_location`
--
...
--
-- AUTO_INCREMENT for table `help_request_location`
--
ALTER TABLE `help_request_location`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;

--
-- AUTO_INCREMENT for table `help_request_provider_need`
--
ALTER TABLE `help_request_provider_need`
...
--
-- AUTO_INCREMENT for table `service_provider_patrol`
--
ALTER TABLE `service_provider_patrol`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `service_provider_patrol_assignment`
--
ALTER TABLE `service_provider_patrol_assignment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `service_provider_patrol_location`
--
ALTER TABLE `service_provider_patrol_location`
